  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <button 
        ...
        className="fixed bottom-8 left-8 z-[5000] w-12 h-12 md:w-14 md:h-14 bg-amber-500 hover:bg-amber-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 border-2 border-white/50 group cursor-pointer"
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            exit={{ opacity: 0, y: 20 }}
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 z-[5000] w-12 h-12 md:w-14 md:h-14 bg-[#101b3a] hover:bg-[#15803d] text-white rounded-full shadow-2xl flex items-center justify-center transition-colors hover:scale-110 active:scale-95 border-2 border-white/50 cursor-pointer"
            aria-label="Torna su"
          >
