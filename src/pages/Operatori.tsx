...
export default function Operatori() {
  const [activeTab, setActiveTab] = useState<'modulo-b' | 'modulo-c' | 'impostazioni'>('modulo-b');
  ...
  // Settings state
  const [siteLogo, setSiteLogo] = useState<string>(() => localStorage.getItem('siteLogo') || "");
  const [siteName, setSiteName] = useState<string>(() => localStorage.getItem('siteName') || "Comune di Naro");
  ...
  const handleSaveSettings = (e: React.FormEvent) => {
    ...
    alert("Impostazioni salvate con successo. Ricarica la pagina per renderle visibili nell'header.");
  };
    ...
    <div className="min-h-screen bg-slate-50/70 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-4 mt-8 border-b border-white/10">
            ...
            <button
              ...
              className={`pb-4 px-2 font-bold text-sm uppercase tracking-wider transition-all border-b-2 ${
                activeTab === 'impostazioni' ? 'border-[#15803d] text-white' : 'border-transparent text-slate-400 hover:text-white'
              }`}
            >
              Impostazioni
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        {activeTab === 'modulo-b' ? (
          ...
          /* ================= IMPOSTAZIONI: BACKEND E PERSONALIZZAZIONE ================= */
          <div className="space-y-8 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
              <h2 className="text-2xl font-black text-[#1e3a5f] mb-6 flex items-center gap-3">
                ...
                Impostazioni Ente e Personalizzazioni
              </h2>
